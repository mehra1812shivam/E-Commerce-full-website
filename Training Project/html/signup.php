    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <img class="img-responsive" src="../images/signupphoto.jpg">
            </div>
            <div class="col-sm-6 col-xs-12">
                ...
                <form method="POST" action="sign_script.php">
						...
						<div class="form-group">	
							<input type="Password" class="form-control" name="password" placeholder="Password" required="true" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$">
						</div>
		...
		<br><p>Aleady Registered? <a data-toggle="modal" data-target="#pz" style="color: teal;">Login</a> </p>
            </div>
        </div>
